  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          {data.offerprice == 0 ? <span style={{ fontWeight: 'bold', color: '#000' }}>₹{data.fullprice}</span> : <><span style={{ fontWeight: 'bold', marginRight: '2%', color: '#000' }}>₹{data.offerprice}</span> <s style={{color:'#323232'}}>₹{data.fullprice}</s></>}
        </div>
